...
def eprintf(*args, **kwargs):
    """Argument list same as print"""
    return colored_print(
        *args, ansi_color_str=ColoredPrintSetting.MSG_COLOR_DICT[logging.ERROR], **kwargs
    )
...
def iprintf(*args, **kwargs):
    """Argument list same as print"""
    return colored_print(
        *args, ansi_color_str=ColoredPrintSetting.MSG_COLOR_DICT[logging.INFO], **kwargs
    )
...
def dprintf(*args, **kwargs):
    """Argument list same as print"""
    return colored_print(
        *args, ansi_color_str=ColoredPrintSetting.MSG_COLOR_DICT[logging.DEBUG], **kwargs
    )
